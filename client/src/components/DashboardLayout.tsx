/** Panel privado Casa & Plano: navegación administrativa mínima y acceso autenticado. */
...
import MidPageCtaControl from "./MidPageCtaControl";
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Inicia sesión para administrar viviendas, consultas y referencias.
            </p>
          </div>
          <Button
            onClick={() => startLogin()}
  ...
  return (
    <>
          ...
          <SidebarFooter className="p-3">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                <DropdownMenuItem
                  onClick={async () => { try { await logout(); } finally { window.location.assign("/"); } }}
      ...
      <SidebarInset>
        ...
        <main className="flex-1 p-4">{children}{location === "/admin" && <><HeroVideoManager /><HeroImageManager /><MidPageCtaControl /><PropertyTypeEnhancer /></>}</main>
      </SidebarInset>
    </>
  );
}
